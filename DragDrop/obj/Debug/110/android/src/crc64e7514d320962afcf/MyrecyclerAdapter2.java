...
public class MyrecyclerAdapter2
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DragDrop.Adapter.MyrecyclerAdapter2, DragDrop", MyrecyclerAdapter2.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == MyrecyclerAdapter2.class)
			mono.android.TypeManager.Activate ("DragDrop.Adapter.MyrecyclerAdapter2, DragDrop", "", this, new java.lang.Object[] {  });
	}
