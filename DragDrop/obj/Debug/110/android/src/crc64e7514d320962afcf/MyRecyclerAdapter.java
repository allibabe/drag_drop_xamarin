...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DragDrop.Adapter.MyRecyclerAdapter, DragDrop", MyRecyclerAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == MyRecyclerAdapter.class)
			mono.android.TypeManager.Activate ("DragDrop.Adapter.MyRecyclerAdapter, DragDrop", "", this, new java.lang.Object[] {  });
	}
